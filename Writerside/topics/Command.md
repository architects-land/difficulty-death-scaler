...
You can get the player difficulty with `/difficultydeathscaler get [player]`.
...
You can set the player difficulty with `/difficultydeathscaler set player [player] difficulty [number of death]`.
Player is obviously a selector targeting one player.

You can also set the number of daily death with
