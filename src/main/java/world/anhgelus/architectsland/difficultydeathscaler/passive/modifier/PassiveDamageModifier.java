...
public class PassiveDamageModifier extends PassiveModifier<HostileEntity> {
    public static final RegistryEntry<EntityAttribute> ATTRIBUTE = EntityAttributes.ATTACK_DAMAGE;
    public static final EntityAttributeModifier.Operation OPERATION = EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE;
    public static final Identifier ID = Identifier.of(PREFIX + "damage");

    private PassiveDamageModifier() {
